...
struct FAkSpatialAudioSettings
{
	...
	UPROPERTY(EditAnywhere, Category = "Ak Initialization Settings|Spatial Audio Settings", meta = (ToolTip = "The number of rays cast from the listeners."))
	uint32 NumberOfPrimaryRays = 100;
	
	UPROPERTY(EditAnywhere, Category = "Ak Initialization Settings|Spatial Audio Settings", meta = (ToolTip = "Maximum reflection order.", ClampMin = "0", ClampMax = "4"))
	...
	UPROPERTY(EditAnywhere, Category = "Ak Initialization Settings|Spatial Audio Settings", meta = (ToolTip = "Enable computation of direct path diffraction. Individual source must enable diffraction in the positioning tab of the authoring tool."))
	bool EnableDirectPathDiffraction = true;
	...
	UPROPERTY(EditAnywhere, Category = "Ak Initialization Settings|Spatial Audio Settings", meta = (ToolTip = "Enable modeling of transmission of sound through walls."))
...
struct FAkAdvancedSpatialAudioSettings
{
	...
	UPROPERTY(EditAnywhere, Category = "Ak Initialization Settings|Advanced Spatial Audio Settings", AdvancedDisplay, meta = (ToolTip = "Multiplier that is applied to the distance attenuation of diffracted sounds (sounds that are in the 'shadow region') to simulate the phenomenon where by diffracted sound waves decay faster than incident sound waves.", ClampMin = "1", ClampMax = "3"))
	float DiffractionShadowAttenuationFactor = 1.0f;

	UPROPERTY(EditAnywhere, Category = "Ak Initialization Settings|Advanced Spatial Audio Settings", AdvancedDisplay, meta = (ToolTip = "Interpolation angle, in degrees, over which the \"Diffraction Shadow Attenuation Factor\" is applied.", ClampMin = "0.1", ClampMax = "180"))
